        ...
        <ul class="teacher-list">
            @foreach($teachers as $teacher)
                <li class="teacher-item">
                    <a href="javascript:void(0)" onclick="openChat({{ $teacher->id }}, '{{ $teacher->name }}')" class="teacher-link">
                        <div class="teacher-avatar">
                            <img src="{{ url('storage/' .  $teacher->img) }}" alt="Ảnh giáo viên">
                        </div>
